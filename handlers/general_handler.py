...
"""
벼리톡@경상남도인재개발원 - 일반정보 핸들러 v1.0

학칙, 규정, 연락처, 교육과정 운영 등 일반 정보 검색
코랩 테스트 검증 완료 (5/5 성공, confidence: 0.479~0.550)
"""
...
class GeneralHandler:
    ...
    def __init__(self):
        ...
        logger.info(f"GeneralHandler 초기화 완료 (k={self.search_k})")
    ...
    def search_chunks(self, query: str) -> List[ChunkResult]:
        ...
        try:
            ...
            if not vectorstore:
                logger.warning("일반정보 벡터스토어를 사용할 수 없습니다")
                return []
            ...
            logger.info(f"일반정보 검색 완료: {len(chunk_results)}개 결과")
