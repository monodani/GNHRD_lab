...
"""
벼리톡@경상남도인재개발원 - 발행물 핸들러 v1.0

교육훈련계획서, 종합평가서 등 공식 발행물 검색
코랩 테스트 검증 완료 (5/5 성공, confidence: 0.433~0.743)
"""
...
class PublishHandler:
    ...
    def __init__(self):
        ...
        logger.info(f"PublishHandler 초기화 완료 (k={self.search_k})")
    ...
    def search_chunks(self, query: str) -> List[ChunkResult]:
        ...
        try:
            ...
            if not vectorstore:
                logger.warning("발행물 벡터스토어를 사용할 수 없습니다")
                return []
            ...
            logger.info(f"발행물 검색 완료: {len(chunk_results)}개 결과")
