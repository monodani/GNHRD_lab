#!/usr/bin/env python3
"""
경상남도인재개발원 RAG 챗봇 - 일반정보 벡터스토어 로더 (간소화)

general.pdf → FAISS 벡터스토어 생성 (PDFPlumber 방식)
"""
...
# 경로 설정
SOURCE_FILE = "data/general/general.pdf"
...
class GeneralLoader:
    ...
    def __init__(self):
        ...
        logger.info("GeneralLoader 간소화 버전 초기화")
    ...
    def build_vectorstore(self, force_rebuild: bool = False) -> bool:
        ...
        try:
            ...
            # 저장 (general_index.faiss, general_index.pkl)
