...
Confidence 기반 응답 타입 결정 (절대적 벡터 유사도 기반):
- 0.0 ~ 0.15: 일상 대화 (벡터스토어 기반 서비스 소개)
- 0.15초과 ~ 0.35: 정보 부족 (담당부서 연락처 제공)
- 0.35초과 ~ 핸들러별기준: 되묻기 ("혹시 이런 의미인가요?")
...
COMMON_THRESHOLDS = {
    "casual_chat": 0.15,        # 일상 대화 임계값 (절대적 유사도 기반)
    "insufficient_info": 0.35   # 정보 부족 임계값 (절대적 유사도 기반)
}
